...
Route::get('/sales/saleforWeek', [SaleController::class, 'getDailySalesThisWeek'])->middleware('auth:sanctum');
...
Route::get('/order/count', [OrderController::class, 'countOrders'])->middleware('auth:sanctum');
